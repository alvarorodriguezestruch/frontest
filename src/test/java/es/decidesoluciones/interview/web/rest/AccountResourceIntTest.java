package es.decidesoluciones.interview.web.rest;

import es.decidesoluciones.interview.config.Constants;
import es.decidesoluciones.interview.FrontestApp;
import es.decidesoluciones.interview.domain.Authority;
import es.decidesoluciones.interview.domain.User;
import es.decidesoluciones.interview.repository.AuthorityRepository;
import es.decidesoluciones.interview.repository.UserRepository;
import es.decidesoluciones.interview.security.AuthoritiesConstants;
import es.decidesoluciones.interview.service.MailService;
import es.decidesoluciones.interview.service.dto.UserDTO;
import es.decidesoluciones.interview.service.dto.PasswordChangeDTO;
import es.decidesoluciones.interview.web.rest.errors.ExceptionTranslator;
import es.decidesoluciones.interview.web.rest.vm.KeyAndPasswordVM;
import es.decidesoluciones.interview.web.rest.vm.ManagedUserVM;
import es.decidesoluciones.interview.service.UserService;
...
@SpringBootTest(classes = FrontestApp.class)
